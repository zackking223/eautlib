        ...
        <tbody>
            <?php foreach ($genres as $i => $genre) : ?>
                <tr>
                    ...
                    <td class="uk-flex">
                        <a id="<?php echo $genre["MATHELOAI"] . "update-btn"?>" class="uk-button uk-button-small uk-button-primary uk-padding-remove uk-margin-small-right" href="/admin/genres/update?id=<?php echo $genre["MATHELOAI"] ?>">
                        ...
                        <form action="/admin/genres/delete" method="post" onsubmit="return confirm('Bạn có chắc muốn xóa?')">
                            ...
                            <button id="<?php echo $genre["MATHELOAI"] . "delete-btn"?>" type="submit" class="uk-button uk-button-small uk-button-danger uk-padding-remove"><span uk-icon="trash"></span></button>
                        </form>
                    </td>
                </tr>
            <?php endforeach; ?>
